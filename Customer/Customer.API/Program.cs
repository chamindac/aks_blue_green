...
// {
    // app.UseSwagger(c =>
    // {
    //     c.RouteTemplate = "customer/api/swagger/{documentname}/swagger.json";
    // });
    // app.UseSwaggerUI(c =>
    // {
    //     c.SwaggerEndpoint("/customer/api/swagger/v1/swagger.json", "Cutomer.API V1");
    //     c.RoutePrefix = "customer/api/swagger";
    // });
    app.UseSwagger();
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Cutomer.API V1");
    });
// }
